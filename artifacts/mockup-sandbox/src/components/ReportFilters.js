...
export const ReportFiltersComponent = ({ onFiltersChange, loading = false }) => {
    ...
    return (<div className="p-4 border rounded-lg bg-gray-50 space-y-4">
      ...
      {dateFilter === "custom" && (<div className="flex justify-end gap-2 pt-4">
          ...
          <button onClick={handleApplyFilters} disabled={loading} className="px-4 py-2 bg-white hover:bg-gray-50 text-navy border-navy border-2 rounded-lg font-medium transition-colors disabled:opacity-50">
