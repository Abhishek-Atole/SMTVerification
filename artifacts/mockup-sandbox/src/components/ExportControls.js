    ...
    return (<div className="p-4 border rounded-lg bg-blue-50 space-y-4">
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-4 items-end">
          ...
          {/* Export Button */}
          <button onClick={handleExport} disabled={loading || exporting} className="px-6 py-2 text-white bg-green-500 rounded-md hover:bg-green-600 disabled:opacity-50 transition flex items-center gap-2">
