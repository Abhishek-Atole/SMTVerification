...
export const getListBomsQueryOptions = <
  ...
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<Awaited<ReturnType<typeof listBoms>>, TError, TData>;
  request?: SecondParameter<typeof customFetch>;
}) => {
  const { query: queryOptions, request: requestOptions } = options ?? {};
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof listBoms>>> = ({
    signal,
  }) => listBoms({ signal, ...requestOptions });
...
>(
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getBom>>> = ({
    signal,
  }) => getBom(bomId, { signal, ...requestOptions });
...
export const addBomItem = async (
  bomId: number,
  createBomItemRequest: CreateBomItemRequest,
  options?: RequestInit,
): Promise<BomItem> => {
...
export const scanFeeder = async (
  sessionId: number,
  scanFeederRequest: ScanFeederRequest,
  options?: RequestInit,
): Promise<ScanResult> => {
...
export const getScanFeederMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type ScanFeederMutationResult = NonNullable<
  Awaited<ReturnType<typeof scanFeeder>>
>;
...
export const getGetSessionReportQueryKey = (sessionId: number) => {
  return [`/api/sessions/${sessionId}/report`] as const;
};

export const getGetSessionReportQueryOptions = <
  TData = Awaited<ReturnType<typeof getSessionReport>>,
  TError = ErrorType<unknown>,
>(
  sessionId: number,
  options?: {
    query?: UseQueryOptions<
      Awaited<ReturnType<typeof getSessionReport>>,
      TError,
      TData
    >;
    request?: SecondParameter<typeof customFetch>;
  ...
  const queryKey =
    queryOptions?.queryKey ?? getGetSessionReportQueryKey(sessionId);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getSessionReport>>
  > = ({ signal }) =>
    getSessionReport(sessionId, { signal, ...requestOptions });
...
export type GetSessionReportQueryResult = NonNullable<
  Awaited<ReturnType<typeof getSessionReport>>
>;
